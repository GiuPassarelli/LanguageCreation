...
class Tokenizer:
    def __init__(self, origin):
        ...
        self.value_dict = {"+": "PLUS", "-": "MINUS", "*": "MULTIPLY", "/": "DIVIDE", "(": "OPEN_PAR", 
                            ")": "CLOSE_PAR", "\n": "ENTER", "!": "NOT", ";": "SEMI_COLLON",
                            ",": "COMMA", "{": "OPEN_KEY", "}": "CLOSE_KEY"}
        self.reserved_dict = {"imprime": "PRINT", "se": "IF", "senao": "ELSE", 
                            "enquanto": "WHILE", "true": "TRUE", "false": "FALSE", "funcao": "FUNCTION", 
                            "retorna": "RETURN", "durante": "FOR", "ate": "UNTIL"}
